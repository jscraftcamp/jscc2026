...
*open round; sharing experiences*

## 🐣 Learnings/Experiences

**Work**

- 💼 both parents working, KITA since 8 month old. Learning: it didn't affect both careers that much
- 👨‍👩‍👧‍👦 a lot of parents in the company === makes it easier
- 🏡 working from home is great to support necessary flexibility (and still get work done at some point)
- 🐦 starting early in work and plan well: what to do so others can work unblocked e.g. *if* I need to head out to get the child from KITA
...
- 🙅‍♂️ Non-negotiables with kids: what do I need if everything else falls backward? Prioritize that. E.g Sleep?!
- 📱 Revenge bed-time procrastination is a thing: once you finally have time for yourself it's late and you don't want to go to be (even if that would be sensible)
- 🪥 get an alarm clock to get ready for bed; keep all mental-load in a notes app to really 
